...
/**
* @brief          Symbolic name for the channel BLUE_LED.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_BLUE_LED ((uint16)0x0060U)

/**
* @brief          Symbolic name for the channel GREEN_LED.
*
*/
...
/**
* @brief          Symbolic name for the channel TRIG_PIN2.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_TRIG_PIN2 ((uint16)0x006bU)
...
/**
* @brief          Symbolic name for the channel TRIG_PIN0.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_TRIG_PIN0 ((uint16)0x0020U)

/**
* @brief          Symbolic name for the channel TRIG_PIN1.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_TRIG_PIN1 ((uint16)0x0023U)
