...
#define CAN_SW_PATCH_VERSION_CFG_H              4
...
*
*/
#define CAN_MAINFUNCTION_PERIOD         (0.5F)
#define CAN_MAINFUNCTION_PERIOD_READ    (0.5F)
#define CAN_MAINFUNCTION_MULTIPLE_READ  (STD_OFF)
#define CAN_MAINFUNCTION_PERIOD_WRITE   (0.5F)
