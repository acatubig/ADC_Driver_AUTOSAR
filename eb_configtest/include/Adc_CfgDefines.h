...
*   @implements     Adc_CfgDefines.h_Artifact
*   @version 1.0.4
*
...
#define ADC_SW_PATCH_VERSION_CFG_DEFINES                4
...
*/
#define ADC_NUM_SC1_N_REGISTER      16U
...
#define ADC_R_N_OFFSET_ADDR32      (0x48UL)
...
*/
#define ADC_NUM_SC1_N_REGISTER_USED 16U
/**
...
/** 
* @brief           Add/Remove AutosarExt Adc_EnableChannel() and Adc_DisableChannel() api.
*/
#define ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API        (STD_OFF)
...
/** 
* @brief          Add/Remove AutosarExt Adc_SetClockMode().
*/
...
*/
#define ADC_ENABLE_CONFIGURE_THRESHOLD_ASR_EXT_API    (STD_OFF)
...
/** 
* @brief          This switch is used to enable the hardware trigger AutosarExt API.
*/
#define ADC_ENABLE_CTUTRIG_ASR_EXT_API              (STD_OFF)
...
/** 
* @brief           This switch is used to enable the AutosarExt ADC performance optimization feature.
*/
