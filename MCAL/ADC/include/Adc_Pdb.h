...
#define ADC_SW_PATCH_VERSION_PDB               4
...
/** @violates @ref Adc_Pdb_h_REF_4 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #ifdef ADC_DMA_SUPPORTED
    /* Check if source file and DMA header file are of the same Autosar version */
    #if ((ADC_AR_RELEASE_MAJOR_VERSION_PDB != MCL_AR_RELEASE_MAJOR_VERSION) || \
         (ADC_AR_RELEASE_MINOR_VERSION_PDB != MCL_AR_RELEASE_MINOR_VERSION)  \
        )
        #error "AutoSar Version Numbers of Adc_Pdb.h and CDD_Mcl.h are different"
    #endif
    #endif
#endif
