...
#if (ADC_ENABLE_CONFIGURE_THRESHOLD_ASR_EXT_API == STD_ON)
/**
...
/** @violates @ref Adc_h_REF_5 MISRA 2004 Required Rule 8.7, objects shall be defined at block scope */
...
#endif /*  ADC_ENABLE_CONFIGURE_THRESHOLD_ASR_EXT_API == STD_ON */
