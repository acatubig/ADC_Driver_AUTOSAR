...
* significance and case sensitivity are supported for external identifiers
*/
#define ADC_SW_PATCH_VERSION_ADC12BSARV2               4
...
/** @violates @ref Adc_Adc12bsarv2_h_REF_4 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #ifdef ADC_DMA_SUPPORTED
    /* Check if source file and DMA header file are of the same Autosar version */
    #if ((ADC_AR_RELEASE_MAJOR_VERSION_ADC12BSARV2 != MCL_AR_RELEASE_MAJOR_VERSION) || \
         (ADC_AR_RELEASE_MINOR_VERSION_ADC12BSARV2 != MCL_AR_RELEASE_MINOR_VERSION)  \
        )
        #error "AutoSar Version Numbers of Adc_Adc12bsarv2.h and CDD_Mcl.h are different"
    #endif
    #endif
#endif
...
#define ADC_ADC12BSARV2_GET_LEFT_CHANNEL(x) ((((x)/ADC_NUM_SC1_N_REGISTER_USED) != 0U) ? ADC_NUM_SC1_N_REGISTER_USED : ((x)%ADC_NUM_SC1_N_REGISTER_USED))
