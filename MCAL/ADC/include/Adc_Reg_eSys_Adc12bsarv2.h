...
#define ADC_SW_PATCH_VERSION_REG               4
...
#define ADC12BSAR_R_N_OFFSET_ADDR32      (ADC_R_N_OFFSET_ADDR32)
...
* @violates @ref Adc_Reg_eSys_Adc12bsarv2_h_REF_1 Function-like macro defined
*/
#define ADC12BSARV2_R_N_REG_ADDR32(HwUnit, Index)       (ADC12BSARV2_ADDR32(HwUnit) + ADC12BSAR_R_N_OFFSET_ADDR32 + ((Index) << 2))
...
* @violates @ref Adc_Reg_eSys_Adc12bsarv2_h_REF_1 Function-like macro defined
*/
#define ADC12BSARV2_CV_N_REG_ADDR32(HwUnit, Index)       (ADC12BSARV2_ADDR32(HwUnit) + 0x0088UL + ((Index) << 2))
...
*/
#define ADC12BSARV2_SC1_N_CONV_COMPLETE_U32                   (0x00000080UL)
/**
* @brief          SC1n reset value: Conversion Complete Flag
*/
#define ADC12BSARV2_SC1_N_RESET_VALUE_U32                     (0x0000001FUL)
/**
