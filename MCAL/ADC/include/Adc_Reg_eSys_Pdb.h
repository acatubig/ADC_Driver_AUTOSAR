...
#define ADC_PDB_SW_PATCH_VERSION_REG               4
...
#if (ADC_PDB_VENDOR_ID_REG != ADC_VENDOR_ID_CFG_DEFINES)
    #error "Adc_Reg_eSys_Pdb.h and Adc_CfgDefines.h have different vendor ids"
#endif
...
/* Check if source file and ADC configuration header file are of the same Autosar version */
     ...
     (ADC_PDB_AR_RELEASE_REVISION_VERSION_REG != ADC_AR_RELEASE_REVISION_VERSION_CFG_DEFINES) \
    )
    #error "AutoSar Version Numbers of Adc_Reg_eSys_Pdb.h and Adc_CfgDefines.h are different"
#endif

/* Check if source file and ADC configuration header file are of the same software version */
#if ((ADC_PDB_SW_MAJOR_VERSION_REG != ADC_SW_MAJOR_VERSION_CFG_DEFINES) || \
     (ADC_PDB_SW_MINOR_VERSION_REG != ADC_SW_MINOR_VERSION_CFG_DEFINES) || \
     (ADC_PDB_SW_PATCH_VERSION_REG != ADC_SW_PATCH_VERSION_CFG_DEFINES) \
    )
    #error "Software Version Numbers of Adc_Reg_eSys_Pdb.h and Adc_CfgDefines.h are different"
#endif
...
* @violates @ref Reg_eSys_Pdb_h_REF_1 Function-like macro defined
*/
#define PDB_CH_N_C1_REG_ADDR32(HwUnit, chNr)          (PDB_ADDR32(HwUnit) + ((chNr) * 0x0028UL) + 0x0010UL)
...
* @violates @ref Reg_eSys_Pdb_h_REF_1 Function-like macro defined
*/
#define PDB_CH_N_S_REG_ADDR32(HwUnit, chNr)           (PDB_ADDR32(HwUnit) + ((chNr) * 0x0028UL) + 0x0014UL)
...
* @violates @ref Reg_eSys_Pdb_h_REF_1 Function-like macro defined
*/
#define PDB_CH_N_DLY_X_REG_ADDR32(HwUnit, chNr, regNr)        (PDB_ADDR32(HwUnit) + ((chNr) * 0x0028UL) + ((regNr) * 0x0004UL) + 0x0018UL)
...
* @violates @ref Reg_eSys_Pdb_h_REF_1 Function-like macro defined
*/
#define PDB_DACINTC_N_REG_ADDR32(HwUnit, chNr)       (PDB_ADDR32(HwUnit) + ((chNr) * 0x0008UL) + 0x0150UL)
...
* @violates @ref Reg_eSys_Pdb_h_REF_1 Function-like macro defined
*/
#define PDB_DACINT_N_REG_ADDR32(HwUnit, chNr)        (PDB_ADDR32(HwUnit) + ((chNr) * 0x0008UL) + 0x0154UL)
...
* @violates @ref Reg_eSys_Pdb_h_REF_1 Function-like macro defined
*/
#define PDB_TRIGGER_N_SEL_U32(nrTrg)                      ((nrTrg) << 8U)
...
#define PDB_DACINTC_N_RESET_VALUE_U32                   (0x0UL)
...
#define PDB_DACINT_N_RESET_VALUE_U32                    (0x0UL)
