...
#define ADC_SW_PATCH_VERSION_TYPES                  4
...
/**
* @brief          Maximum medium accuracy Internal channel range from 32 to 63
*/
#define ADC_ST_INTERNAL_CH_U8            (32U)
#define ADC_ED_INTERNAL_CH_U8            (63U)
...
typedef struct
{
    ...
    VAR(uint32, AUTOMATIC) Adc_u32NCMR1; /**< @brief Internal configured channels */
