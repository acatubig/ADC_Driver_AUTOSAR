...
#define ADC_SW_PATCH_VERSION_C                  4
...
#if (ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API == STD_ON)
/**
* @brief          Unit status structure
* @details        Structure for the unit status.
*
...
#endif /* ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API == STD_ON */
...
#if (ADC_ENABLE_CTUTRIG_ASR_EXT_API == STD_ON)
...
/** @violates @ref Adc_c_REF_6 Repeated include file MemMap.h*/
#include "Adc_MemMap.h"
#endif /* ADC_ENABLE_CTUTRIG_ASR_EXT_API == STD_ON */
...
#include "Adc_MemMap.h"
     ...
     ((ADC_ENABLE_START_STOP_GROUP_API == STD_ON) || \
      ...
      (ADC_ENABLE_CTUTRIG_ASR_EXT_API ==STD_ON) || \
      (ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API == STD_ON) \
     ) \
    )
...
#if (ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API == STD_ON) || (ADC_HW_TRIGGER_API == STD_ON) || \
    (ADC_ENABLE_CTUTRIG_ASR_EXT_API == STD_ON)
...
#if ( \
        ((ADC_HW_TRIGGER_API == STD_ON) && (ADC_ENABLE_QUEUING == STD_OFF)) || (ADC_DEINIT_API == STD_ON) \
        || defined(__DOXYGEN__) \
...
#if (((ADC_GET_INJECTED_CONVERSION_STATUS_API == STD_ON) || (ADC_CALIBRATION == STD_ON) || (ADC_SELF_TEST == STD_ON) || (ADC_ENABLE_CTU_CONTROL_MODE_API == STD_ON)) && \
...
#endif
#if ((ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API == STD_ON) || (ADC_HW_TRIGGER_API == STD_ON) || (ADC_ENABLE_CTUTRIG_ASR_EXT_API == STD_ON))
...
#if (((ADC_GET_INJECTED_CONVERSION_STATUS_API == STD_ON) || (ADC_CALIBRATION == STD_ON) || (ADC_SELF_TEST == STD_ON) || (ADC_ENABLE_CTU_CONTROL_MODE_API == STD_ON) || defined(__DOXYGEN__)) && \
     (ADC_VALIDATE_CALL_AND_UNIT == STD_ON) \
    )
/**
...
)
{
    ...
    VAR(Adc_QueueIndexType, AUTOMATIC) CurrentIndex = 0U;
...
)
{
    ...
    switch(u8ServiceId)
    {
        ...
        case ADC_DISABLECTUCONTROLMODE_ID:
        {
            ...
            {
                ValidState = (Std_ReturnType)E_NOT_OK;
                Adc_ReportDetRuntimeError((uint8)ADC_DISABLECTUCONTROLMODE_ID, (uint8)ADC_E_IDLE);
            }
            break;
        }
        default:
...
* @api
*
* @note           The function Autosar Extension Service ID[hex]: 0x23.
* @note           Synchronous.
* @note           Non Re-entrant function.
...
#if (ADC_ENABLE_CTUTRIG_ASR_EXT_API == STD_ON) || defined(__DOXYGEN__)
/**
...
* @api
*
* @note           The function Autosar Extension Service ID[hex]: 0x21.
* @note           Synchronous.
* @note           Non Re-entrant function.
...
* @api
*
* @note           The function Autosar Extension Service ID[hex]: 0x22.
* @note           Synchronous.
* @note           Non Re-entrant function.
...
* @api
*
* @note           The function Autosar Extension Service ID[hex]: 0x20.
* @note           Synchronous.
* @note           Non Re-entrant function.
...
#endif /* (ADC_ENABLE_CTUTRIG_ASR_EXT_API == STD_ON) || defined(__DOXYGEN__) */

#if (ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API == STD_ON) || defined(__DOXYGEN__)
/**
...
* @api
*
* @note           The function Autosar Extension Service ID[hex]: 0x25.
* @note           Synchronous.
* @note           Re-entrant function.
...
#endif /* ADC_VALIDATE_CALL_AND_GROUP == STD_ON */
    {
           ...
           )
        {
            if ((Std_ReturnType)E_OK == Adc_ValidateEnableDisbleIdList(ADC_ENABLE_CHANNEL_ID, Group, Channel))
            {
                ...
                if(ChId < ADC_ST_INTERNAL_CH_U8)
                {
                    /* Precision channel */
                    Adc_aNCMRxMask[GroupId].Adc_u32NCMR0 = (CmrMask.Adc_u32NCMR0 | ((uint32)1UL << ChId));
                }
                else if ((ChId >= ADC_ST_INTERNAL_CH_U8) && (ChId <= ADC_ED_INTERNAL_CH_U8))
                {
                    /* Standard channel */
                    Adc_aNCMRxMask[GroupId].Adc_u32NCMR1 = (CmrMask.Adc_u32NCMR1 | ((uint32)1UL << (ChId - ADC_ST_INTERNAL_CH_U8)));
                }
...
*
* @api
* @note           The function Autosar Extension Service ID[hex]: 0x26.
* @note           Synchronous.
* @note           Re-entrant function.
...
#endif /* (ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API == STD_ON) || defined(__DOXYGEN__) */
...
*
* @api
* @note           The function Autosar Extension Service ID[hex]: 0x27.
* @note           Synchronous.
* @note           Re-entrant function.
...
* @api
*
* @note           The function Autosar Extension Service ID[hex]: 0x28.
* @note           Synchronous.
* @note           Non Re-entrant function.
...
* @api
*
* @note           The function Autosar Extension Service ID[hex]: 0x29.
* @note           Synchronous.
* @note           Non Re-entrant function.
...
#if (ADC_ENABLE_CONFIGURE_THRESHOLD_ASR_EXT_API == STD_ON) || defined(__DOXYGEN__)
/**
 * @brief   Function to reconfigure High and Low thresholds for a given group.
 *
 * @details This Autosar Extension API is used to reconfigure High and Low thresholds for a given group.
 *
 ...
 * @api
 *
 * @note           The function Autosar Extension Service ID[hex]: 0x2A.
 * @note           Synchronous.
 * @note           Non Re-entrant function.
...
#endif /* ADC_ENABLE_CONFIGURE_THRESHOLD_ASR_EXT_API == STD_ON || defined(__DOXYGEN__) */
...
* @api
*
* @note           The function Autosar Extension Service ID[hex]: 0x24.
* @note           Synchronous.
* @note           Non Re-entrant function.
 ...
 * @api
 *
 * @note           The function Autosar Extension Service ID[hex]: 0x2B.
 * @note           Synchronous.
 * @note           Non Re-entrant function.
 ...
 * @api
 *
 * @note           The function Autosar Extension Service ID[hex]: 0x2C.
 * @note           Synchronous.
 * @note           Non Re-entrant function.
 ...
 * @api
 *
 * @note           The function Autosar Extension Service ID[hex]: 0x2D.
 * @note           Synchronous.
 * @note           Non Re-entrant function.
 ...
 * @api
 *
 * @note           The function Autosar Extension Service ID[hex]: 0x2E.
 * @note           Synchronous.
 * @note           Non Re-entrant function.
 ...
 * @api
 *
 * @note           The function Autosar Extension Service ID[hex]: 0x2F.
 * @note           Synchronous.
 * @note           Non Re-entrant function.
 *
 ...
 * @api
 *
 * @note           The function Autosar Extension Service ID[hex]: 0x30.
 * @note           Synchronous.
 * @note           Non Re-entrant function.
 *
 ...
 * @api
 *
 * @note           The function Autosar Extension Service ID[hex]: 0x31.
 * @note           Synchronous.
 * @note           Non Re-entrant function.
 *
    ...
    if ((Std_ReturnType)E_OK == Adc_ValidateCallAndGroup(ADC_SETCHANNEL_ID, Group))
    {
    ...
    #endif /* (defined(ADC_PDB_SUPPORTED) || defined(ADC_PTUV3_SUPPORTED)) */
        {
            Adc_ReportDetError(ADC_SETCHANNEL_ID, (uint8)ADC_E_PARAM_POINTER);
                ...
                #ifdef ADC_PDB_SUPPORTED
                || (NumberOfChannel > ADC_NUM_SC1_N_REGISTER_USED)
                #endif
...
)
{
...
#if (ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API == STD_ON) || (ADC_SETCHANNEL_API == STD_OFF)
    /** @violates @ref Adc_c_REF_4 Array indexing shall be the only allowed form of pointer arithmetic */
    P2CONST(Adc_GroupConfigurationType, AUTOMATIC, ADC_APPL_CONST) pGroupPtr =  &(Adc_pCfgPtr->pGroups[Group]);
#endif /* (ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API == STD_ON) || (ADC_SETCHANNEL_API == STD_OFF) */
...
#endif /* (ADC_ENABLE_CH_DISABLE_CH_ASR_EXT_API == STD_ON) */
    {
        ...
        for(Ch = 0U; Ch < Adc_aRuntimeGroupChannel[Group].ChannelCount; Ch++)
        {
            ...
            {
                pCmrMask->Adc_u32NCMR1 |= (uint32)(1UL << ((uint32)ChId - ADC_ST_INTERNAL_CH_U8));
            }
            #endif
            #if ((ADC_NCMR2_AVAILABLE == STD_ON) || (ADC_JCMR2_AVAILABLE == STD_ON))
            else if ((ChId >= ADC_ST_EXTERNAL_CH_U8) && (ChId <= ADC_ED_EXTERNAL_CH_U8))
        ...
        #if ((ADC_NCMR1_AVAILABLE == STD_ON) || (ADC_JCMR1_AVAILABLE == STD_ON))
        pCmrMask->Adc_u32NCMR1 = pGroupPtr->u32InternalChannel;
