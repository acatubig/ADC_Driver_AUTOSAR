...
#define PORT_PORT_CI_SW_PATCH_VERSION_C              4
...
/* Check if the files Port_Port_Ci.c and modules.h are of the same vendor */
    ...
    #endif
    /* Check if the files Port_Port_Ci.c and SchM_Port.h are of the same version */
    #if ((PORT_PORT_CI_AR_RELEASE_MAJOR_VERSION_C != SCHM_PORT_AR_RELEASE_MAJOR_VERSION) || \
         (PORT_PORT_CI_AR_RELEASE_MINOR_VERSION_C != SCHM_PORT_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AUTOSAR Version Numbers of Port_Port_Ci.c and SchM_Port.h are different"
    #endif
#endif
/* Check if the files Port_Port_Ci.c and modules.h are of the same vendor */
...
/* Check if Port_Port_Ci.c and Port_Reg_eSys_Gpio.h are of the same vendor */
#if (PORT_PORT_CI_VENDOR_ID_C != PORT_REGESYS_GPIO_VENDOR_ID_REG) 
    #error "Port_Port_Ci.c and Port_Reg_eSys_Gpio.h have different vendor ids"
#endif
/* Check if Port_Port_Ci.c and Port_Reg_eSys_Gpio.h are of the same Autosar version */
#if ((PORT_PORT_CI_AR_RELEASE_MAJOR_VERSION_C    != PORT_REGESYS_GPIO_AR_RELEASE_MAJOR_VERSION_REG) || \
     (PORT_PORT_CI_AR_RELEASE_MINOR_VERSION_C    != PORT_REGESYS_GPIO_AR_RELEASE_MINOR_VERSION_REG) || \
     (PORT_PORT_CI_AR_RELEASE_REVISION_VERSION_C != PORT_REGESYS_GPIO_AR_RELEASE_REVISION_VERSION_REG) \
    )
    #error "AutoSar Version Numbers of Port_Port_Ci.c and Port_Reg_eSys_Gpio.h are different"
#endif
/* Check if Port_Port_Ci.c and Port_Reg_eSys_Gpio.h are of the same software version */
#if ((PORT_PORT_CI_SW_MAJOR_VERSION_C != PORT_REGESYS_GPIO_SW_MAJOR_VERSION_REG) || \
     (PORT_PORT_CI_SW_MINOR_VERSION_C != PORT_REGESYS_GPIO_SW_MINOR_VERSION_REG) || \
     (PORT_PORT_CI_SW_PATCH_VERSION_C != PORT_REGESYS_GPIO_SW_PATCH_VERSION_REG)    \
    )
    ...
    if (((boolean)TRUE == pConfigPtr->pUsedPadConfig[PinIndex].bDC) || ((uint16)0 != (u16PinChangeDirFlagWord & (uint16)(1UL<<u8PinDescBitOffset))))
    {
        ...
        else if ((PORT_PIN_IN == eDirection) || (PORT_PIN_HIGH_Z == eDirection))
        {
            ...
            else 
            {
                /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
                REG_BIT_CLEAR32(GPIO_PIDR_ADDR32(GPIO_PORT_U32(Pin)), (uint32)(1UL << GPIO_CHANNEL_U32(Pin)));
            }
        }
        else
        {
        ...
        if(GPIO_PORT_U32(Pin1) == GPIO_PORT_U32(Pin2))
        {
            ...
            else if ((PORT_PIN_IN == eDirection)  || (PORT_PIN_HIGH_Z == eDirection))
            {
                ...
                else 
                {
                    /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
                    REG_BIT_CLEAR32(GPIO_PIDR_ADDR32(GPIO_PORT_U32(Pin1)), (uint32)(1UL << GPIO_CHANNEL_U32(Pin1)) | (uint32)(1UL << GPIO_CHANNEL_U32(Pin2)));
                }
            }
            else
            {
        ...
        else
        {
            ...
            else if ((PORT_PIN_IN == eDirection) || (PORT_PIN_HIGH_Z == eDirection))
            {
                ...
                else 
                {
                    /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
                    REG_BIT_CLEAR32(GPIO_PIDR_ADDR32(GPIO_PORT_U32(Pin1)), (uint32)(1UL << GPIO_CHANNEL_U32(Pin1)));
                    /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
                    /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
                    REG_BIT_CLEAR32(GPIO_PIDR_ADDR32(GPIO_PORT_U32(Pin2)), (uint32)(1UL << GPIO_CHANNEL_U32(Pin2)));
                }
            }
            else
            {
...
)
{
    ...
    /* Check the pin if it is DISABLE (analog) mode. */
    if((uint8)0U == PinCfgRegValue)
    {
        /* Check if the PE and PS fields set or not. */
        if((uint32)0U != (u32LocalPCR & PORT_CI_PCR_PE_PS_MASK_U32))
        {
            /* Before entering Analog mode, PE and PS should be configured as 0 in corresponding PCR register. */
            /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer */
            /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
            REG_WRITE32(PORT_PORT_CI_PCR_ADDR32(PinCfgRegIndex), u32LocalPCR & (~(PORT_CI_PCR_PE_PS_MASK_U32)));            
        }
    }
...
* @post none
*/
FUNC(void, PORT_CODE) Port_Port_Ci_SetAsUnusedPin
(
    VAR     (Port_PinType,          AUTOMATIC)                  PinIndex,
    P2CONST (Port_ConfigType, AUTOMATIC,  PORT_APPL_CONST)      pConfigPtr
)
...
* @post none
*/
FUNC(void, PORT_CODE) Port_Port_Ci_SetAsUsedPin
(
    VAR     (Port_PinType,          AUTOMATIC)                  PinIndex,
    P2CONST (Port_ConfigType, AUTOMATIC,  PORT_APPL_CONST)      pConfigPtr
)
{
    ...
    * @violates @ref Port_Port_Ci_C_REF_7 Violates MISRA 2004 Required Rule 17.4 
    */
    eLocalPDDIR = pConfigPtr->pUsedPadConfig[PinIndex].ePDDir;
...
* @post none
*/
FUNC(void, PORT_CODE) Port_Port_Ci_ResetPinMode
(
    VAR     (Port_PinType,          AUTOMATIC)                  PinIndex,
    P2CONST (Port_ConfigType, AUTOMATIC,  PORT_APPL_CONST)      pConfigPtr
)
{
    VAR(uint32, AUTOMATIC) u32LocalPCR;
    VAR(uint32, AUTOMATIC) u32LocalAltModePCR;
    VAR(Port_PinDirectionType, AUTOMATIC)  eLocalPDDIR;
    VAR(Port_InternalPinIdType, AUTOMATIC) Pin;
    ...
    /* Get the Mode of Pin in PCR register. */
    /* @violates @ref Port_Port_Ci_C_REF_7 Violates MISRA 2004 Required Rule 17.4 */ 
    u32LocalAltModePCR = (pConfigPtr->pUsedPadConfig[PinIndex].u32PCR) & PORT_CI_PCR_ALT_MODE_U32;
    ...
    /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer */
    /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
    u32LocalPCR = REG_READ32(PORT_PORT_CI_PCR_ADDR32(Pin));
    
    /* Check the pin if it is DISABLE (analog) mode. */
    if((uint32)0U == u32LocalAltModePCR)
    {
        /* Check if the PE and PS fields set or not. */
        if((uint32)0U != (u32LocalPCR & PORT_CI_PCR_PE_PS_MASK_U32))
        {
            ...
            /* @violates @ref Port_Port_Ci_C_REF_5 Violates MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer */
            /* @violates @ref Port_Port_Ci_C_REF_10 A cast should not be performed between a pointer type and an integral type. */
            REG_WRITE32(PORT_PORT_CI_PCR_ADDR32(Pin), u32LocalPCR & (~(PORT_CI_PCR_PE_PS_MASK_U32)));            
        }
    }
    u32LocalPCR &= ~(PORT_CI_PCR_ALT_MODE_U32);

    u32LocalPCR |= u32LocalAltModePCR;
