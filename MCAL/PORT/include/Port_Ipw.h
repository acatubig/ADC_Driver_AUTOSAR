...
#define PORT_SW_PATCH_VERSION_IPW_H             4
...
/**
* @brief  Mapping between low level layer and high level layer for Port_Ipw_SetAsUnusedPin function.
*/
#define Port_Ipw_SetAsUnusedPin       (Port_Port_Ci_SetAsUnusedPin)
/**
* @brief  Mapping between low level layer and high level layer for Port_Ipw_SetAsUsedPin function.
*/
#define Port_Ipw_SetAsUsedPin         (Port_Port_Ci_SetAsUsedPin)
...
/**
* @brief  Mapping between low level layer and high level layer for Port_Ipw_ResetPinMode function.
*/
#define Port_Ipw_ResetPinMode         (Port_Port_Ci_ResetPinMode)
