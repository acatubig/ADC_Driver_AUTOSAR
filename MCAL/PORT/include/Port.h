...
#define PORT_SW_PATCH_VERSION             4
...
*
*/
#define PORT_SETASUNUSEDPIN_ID          ((uint8)0x06)
/**
...
*
*/
#define PORT_SETASUSEDPIN_ID            ((uint8)0x07)
/**
...
*
*/
#define PORT_RESETPINMODE_ID            ((uint8)0x08)
/* Errors IDs */
/**
...
/*
* Configure the referenced pin with all properties specified in the NotUsedPortPin container.
*/
FUNC(void, PORT_CODE) Port_SetAsUnusedPin
(
    VAR(Port_PinType,       AUTOMATIC) Pin
);
/*
...
*/
FUNC(void, PORT_CODE) Port_SetAsUsedPin
(
    VAR(Port_PinType,       AUTOMATIC) Pin
);
...
*/
FUNC(void, PORT_CODE) Port_ResetPinMode
(
    VAR(Port_PinType,       AUTOMATIC) Pin
);
