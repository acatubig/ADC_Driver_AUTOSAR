...
#define SCHM_PORT_AR_RELEASE_MINOR_VERSION_C     3
#define SCHM_PORT_AR_RELEASE_REVISION_VERSION_C  1
#define SCHM_PORT_SW_MAJOR_VERSION_C             1
#define SCHM_PORT_SW_MINOR_VERSION_C             0
#define SCHM_PORT_SW_PATCH_VERSION_C             4
/*==================================================================================================
...
#if (defined(_GREENHILLS_C_S32K1xx_) || defined(_DIABDATA_C_S32K1xx_) || defined(_CODEWARRIOR_C_S32K1xx_))
/*================================================================================================*/
/** 
...
FUNC(uint32, RTE_CODE) Port_schm_read_msr(void)
{
    ...
    #elif (defined MCAL_PLATFORM_ARM_M0PLUS)
