...
#define MCL_DMAMUX_SW_PATCH_VERSION_C             4
...
#if (MCL_DMAMUX_VENDOR_ID_C != MCL_VENDOR_ID_CFG)
    #error "Mcl_DmaMux.c and CDD_Mcl_Cfg.h have different vendor IDs"
#endif
/* Check if source file and CDD_Mcl_Cfg header file are of the same Autosar version */
#if ((MCL_DMAMUX_AR_RELEASE_MAJOR_VERSION_C != MCL_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (MCL_DMAMUX_AR_RELEASE_MINOR_VERSION_C != MCL_AR_RELEASE_MINOR_VERSION_CFG) || \
     (MCL_DMAMUX_AR_RELEASE_REVISION_VERSION_C != MCL_AR_RELEASE_REVISION_VERSION_CFG) \
    )
    #error "AutoSar Version Numbers of CDD_Mcl_Cfg.h and Mcl_DmaMux.c are different"
#endif
/* Check if source file and CDD_Mcl_Cfg header file are of the same Software version */
#if ((MCL_DMAMUX_SW_MAJOR_VERSION_C != MCL_SW_MAJOR_VERSION_CFG) || \
     (MCL_DMAMUX_SW_MINOR_VERSION_C != MCL_SW_MINOR_VERSION_CFG) || \
     (MCL_DMAMUX_SW_PATCH_VERSION_C != MCL_SW_PATCH_VERSION_CFG) \
    )
    #error "Software Version Numbers of CDD_Mcl_Cfg.h and Mcl_DmaMux.c are different"
#endif

#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if current file and modules header file are of the same Autosar version */
    #if (( MCL_DMAMUX_AR_RELEASE_MAJOR_VERSION_C != REGLOCKMACROS_AR_RELEASE_MAJOR_VERSION) || \
         ( MCL_DMAMUX_AR_RELEASE_MINOR_VERSION_C != REGLOCKMACROS_AR_RELEASE_MINOR_VERSION) \
        )
         #error "AutoSar Version Numbers of RegLockMacros.h and Mcl_DmaMux.c are different"
    #endif
#endif
