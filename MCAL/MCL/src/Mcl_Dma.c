...
#define MCL_DMA_SW_PATCH_VERSION_C             4
...
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((MCL_DMA_AR_RELEASE_MAJOR_VERSION_C != SCHM_MCL_AR_RELEASE_MAJOR_VERSION) || \
         (MCL_DMA_AR_RELEASE_MINOR_VERSION_C != SCHM_MCL_AR_RELEASE_MINOR_VERSION) \
        )
            #error "AutoSar Version Numbers of Mcl_Dma.c and SchM_Mcl.h are different"
    #endif
#endif
...
#if (MCL_DMA_VENDOR_ID_C != MCL_VENDOR_ID)
    #error "Mcl_Dma.c and CDD_Mcl.h have different vendor IDs"
#endif
/* Check if source file and CDD_Mcl header file are of the same Autosar version */
#if ((MCL_DMA_AR_RELEASE_MAJOR_VERSION_C != MCL_AR_RELEASE_MAJOR_VERSION) || \
     (MCL_DMA_AR_RELEASE_MINOR_VERSION_C != MCL_AR_RELEASE_MINOR_VERSION) || \
     (MCL_DMA_AR_RELEASE_REVISION_VERSION_C != MCL_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of CDD_Mcl.h and Mcl_Dma.c are different"
#endif
/* Check if source file and CDD_Mcl header file are of the same Software version */
#if ((MCL_DMA_SW_MAJOR_VERSION_C != MCL_SW_MAJOR_VERSION) || \
     (MCL_DMA_SW_MINOR_VERSION_C != MCL_SW_MINOR_VERSION) || \
     (MCL_DMA_SW_PATCH_VERSION_C != MCL_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Mcl.h and Mcl_Dma.c are different"
#endif

#if (MCL_DMA_VENDOR_ID_C != MCL_VENDOR_ID_CFG)
    #error "Mcl_Dma.c and CDD_Mcl_Cfg.h have different vendor IDs"
#endif

/* Check if source file and CDD_Mcl_Cfg header file are of the same Autosar version */
#if ((MCL_DMA_AR_RELEASE_MAJOR_VERSION_C != MCL_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (MCL_DMA_AR_RELEASE_MINOR_VERSION_C != MCL_AR_RELEASE_MINOR_VERSION_CFG) || \
     (MCL_DMA_AR_RELEASE_REVISION_VERSION_C != MCL_AR_RELEASE_REVISION_VERSION_CFG) \
    )
    #error "AutoSar Version Numbers of CDD_Mcl_Cfg.h and Mcl_Dma.c are different"
#endif
/* Check if source file and CDD_Mcl_Cfg header file are of the same Software version */
#if ((MCL_DMA_SW_MAJOR_VERSION_C != MCL_SW_MAJOR_VERSION_CFG) || \
     (MCL_DMA_SW_MINOR_VERSION_C != MCL_SW_MINOR_VERSION_CFG) || \
     (MCL_DMA_SW_PATCH_VERSION_C != MCL_SW_PATCH_VERSION_CFG) \
    )
    #error "Software Version Numbers of CDD_Mcl_Cfg.h and Mcl_Dma.c are different"
#endif

#if (MCL_DMA_VENDOR_ID_C != MCL_IPW_VENDOR_ID)
    #error "Mcl_Dma.c and Mcl_IPW.h have different vendor IDs"
#endif

/* Check if source file and Mcl_IPW header file are of the same Autosar version */
#if ((MCL_DMA_AR_RELEASE_MAJOR_VERSION_C != MCL_IPW_AR_RELEASE_MAJOR_VERSION) || \
     (MCL_DMA_AR_RELEASE_MINOR_VERSION_C != MCL_IPW_AR_RELEASE_MINOR_VERSION) || \
     (MCL_DMA_AR_RELEASE_REVISION_VERSION_C != MCL_IPW_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of s.h and Mcl_Dma.c are different"
#endif
/* Check if source file and Mcl_IPW header file are of the same Software version */
#if ((MCL_DMA_SW_MAJOR_VERSION_C != MCL_IPW_SW_MAJOR_VERSION) || \
     (MCL_DMA_SW_MINOR_VERSION_C != MCL_IPW_SW_MINOR_VERSION) || \
     (MCL_DMA_SW_PATCH_VERSION_C != MCL_IPW_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcl_IPW.h and Mcl_Dma.c are different"
#endif
...
#if (MCL_DMA_VENDOR_ID_C != MCL_IPW_NOTIF_VENDOR_ID)
    #error "Mcl_Dma.c and Mcl_IPW_Notif.h have different vendor IDs"
#endif

/* Check if source file and Mcl_IPW_Notif header file are of the same Autosar version */
#if ((MCL_DMA_AR_RELEASE_MAJOR_VERSION_C != MCL_IPW_NOTIF_AR_RELEASE_MAJOR_VERSION) || \
     (MCL_DMA_AR_RELEASE_MINOR_VERSION_C != MCL_IPW_NOTIF_AR_RELEASE_MINOR_VERSION) || \
     (MCL_DMA_AR_RELEASE_REVISION_VERSION_C != MCL_IPW_NOTIF_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcl_IPW_Notif.h and Mcl_Dma.c are different"
#endif
/* Check if source file and Mcl_IPW_Notif header file are of the same Software version */
#if ((MCL_DMA_SW_MAJOR_VERSION_C != MCL_IPW_NOTIF_SW_MAJOR_VERSION) || \
     (MCL_DMA_SW_MINOR_VERSION_C != MCL_IPW_NOTIF_SW_MINOR_VERSION) || \
     (MCL_DMA_SW_PATCH_VERSION_C != MCL_IPW_NOTIF_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcl_IPW_Notif.h and Mcl_Dma.c are different"
#endif
/*==================================================================================================
*                                       LOCAL MACROS
==================================================================================================*/
...
LOCAL_INLINE FUNC(boolean, MCL_CODE) Mcl_DmaCheckChannelInconsistentError( VAR(Mcl_DmaChannelType,AUTOMATIC) hwChannel,
                                                                           VAR(uint32,AUTOMATIC) u32GlobalErrorStatus,
                                                                           VAR(uint8,AUTOMATIC) u8ChannelErrorStatus
                                                                         );

#if (MCL_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
LOCAL_INLINE FUNC(void, MCL_CODE) Mcl_DmaReportDemError(VAR(uint32,AUTOMATIC) u32GlobalErrorStatus, VAR(Mcl_DmaChannelErrorStatusType,AUTOMATIC) u8errorStatus);
#endif
#endif /*((MCL_DMA_GET_GLOBAL_ERR_STATUS_API == STD_ON) || (MCL_DMA_GET_CH_ERR_STATUS_API == STD_ON))*/
/*==================================================================================================
*                                       LOCAL FUNCTIONS
==================================================================================================*/
...
{
    VAR(boolean, AUTOMATIC) bInconsistentError = (boolean)FALSE;
    ...
    if(((((uint32)MCL_DMA_NO_ERROR != u32GlobalErrorStatus) && ((uint32)hwChannel == u32ErrChannel)) && ((uint8)MCL_DMA_NO_ERROR == u8ChannelErrorStatus))||
      ...
      {
          bInconsistentError = (boolean)TRUE;
      }
    return bInconsistentError;
}

#if (MCL_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
LOCAL_INLINE FUNC(void, MCL_CODE) Mcl_DmaReportDemError(VAR(uint32,AUTOMATIC) u32GlobalErrorStatus, VAR(Mcl_DmaChannelErrorStatusType,AUTOMATIC) u8errorStatus)
{
    if(MCL_DMA_HW_INCONSISTENCY_ERROR == u8errorStatus)
    {
    ...
    if (u8errorStatus == MCL_DMA_UNRECOGNIZED_ERROR)
    {
    ...
    else if (u8errorStatus == MCL_DMA_NO_ERROR)
    {
        if((uint32)STD_ON == Mcl_pDemCfgPtr->Mcl_E_Dma_Unrecognized.state)
        {
...
)
{
    ...
    /* report errorstatus */
    if(Mcl_DmaCheckChannelInconsistentError(hwChannel, u32GlobalErrorStatus, u8ChannelErrorStatus))
    {
...
#if (MCL_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
    Mcl_DmaReportDemError(u32GlobalErrorStatus,errorStatus);
#endif
    return errorStatus;
}
#endif
