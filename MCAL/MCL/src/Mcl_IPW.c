...
#define MCL_IPW_SW_PATCH_VERSION_C              4
/*==================================================================================================
*                                       FILE VERSION CHECKS
==================================================================================================*/
...
/* Check if source file and StdRegMacros header file are of the same Autosar version */
    ...
    #endif
#endif
/* Check if source file and SchM_Mcl header file are of the same Autosar version */
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    #if ((MCL_IPW_AR_RELEASE_MAJOR_VERSION_C != SCHM_MCL_AR_RELEASE_MAJOR_VERSION) || \
         (MCL_IPW_AR_RELEASE_MINOR_VERSION_C != SCHM_MCL_AR_RELEASE_MINOR_VERSION) \
        )
            #error "AutoSar Version Numbers of Mcl_IPW.c and SchM_Mcl.h are different"
    #endif
#endif
...
#if (MCL_IPW_VENDOR_ID_C != MCL_NOTIF_VENDOR_ID)
#error "Mcl_IPW.c and Mcl_Notif.h have different vendor IDs"
#endif
/* Check if source file and Mcl_Notif header file are of the same Autosar version */
#if ((MCL_IPW_AR_RELEASE_MAJOR_VERSION_C != MCL_NOTIF_AR_RELEASE_MAJOR_VERSION) || \
     (MCL_IPW_AR_RELEASE_MINOR_VERSION_C != MCL_NOTIF_AR_RELEASE_MINOR_VERSION) || \
     (MCL_IPW_AR_RELEASE_REVISION_VERSION_C != MCL_NOTIF_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcl_Notif.h and Mcl_IPW.c are different"
    #endif
/* Check if source file and Mcl_Notif header file are of the same Software version */
#if ((MCL_IPW_SW_MAJOR_VERSION_C != MCL_NOTIF_SW_MAJOR_VERSION) || \
     (MCL_IPW_SW_MINOR_VERSION_C != MCL_NOTIF_SW_MINOR_VERSION) || \
     (MCL_IPW_SW_PATCH_VERSION_C != MCL_NOTIF_SW_PATCH_VERSION) \
    )
#error "Software Version Numbers of Mcl_Notif.h and Mcl_IPW.c are different"
#endif
/*==================================================================================================
                                                   ...
                                                   )
{
    ...
    Mcl_Dma_ConfigLinkedChannel( (*(Mcl_DmaConfigPtr->pChannelsConfig))[dma_channel].Dma_Channel, config_descriptor,
 ...
 *
 */
FUNC(void, MCL_CODE) Mcl_IPW_DmaStartChannel( P2CONST(Mcl_DmaConfigType, AUTOMATIC, MCL_APPL_CONST) Mcl_DmaConfigPtr, VAR(Mcl_ChannelType, AUTOMATIC) nChannel)
{
 ...
 *
 */
FUNC(boolean, MCL_CODE) Mcl_IPW_DmaIsTransferCompleted( P2CONST(Mcl_DmaConfigType, AUTOMATIC, MCL_APPL_CONST) Mcl_DmaConfigPtr, VAR(Mcl_ChannelType, AUTOMATIC) nChannel)
{
 ...
 *
 */
FUNC(boolean, MCL_CODE) Mcl_IPW_DmaIsTransferActive( P2CONST(Mcl_DmaConfigType, AUTOMATIC, MCL_APPL_CONST) Mcl_DmaConfigPtr, VAR(Mcl_ChannelType, AUTOMATIC) nChannel)
{
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaAcknowledgeInterrupt( P2CONST(Mcl_DmaConfigType, AUTOMATIC, MCL_APPL_CONST) Mcl_DmaConfigPtr, VAR(Mcl_ChannelType,AUTOMATIC) ChannelNumber)
{
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetSaddr( P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(uint32, AUTOMATIC) Saddr)
{
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetSoff( P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(sint16, AUTOMATIC) Soff )
{
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetSga(P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(uint32, AUTOMATIC) Sga)
{
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetDlast(P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(sint32, AUTOMATIC) Dlast)
{
    /* Call the DMA macro for setting the DLASTSGA */
    /** @violates @ref Mcl_IPW_c_REF_5 MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
    /** @violates @ref Mcl_IPW_c_REF_13 MISRA 2004 Advisory Rule 11.3, A Cast should not be performed between a pointer type and an integral type */
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetDaddr(P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(uint32, AUTOMATIC) Daddr)
{
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetDoff(P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(sint16, AUTOMATIC) Doff)
{
    /* Enter exclusive area to protect TCD words 2,6,8 */
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetCiter(P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(uint16, AUTOMATIC) Citer)
{
    /* Enter exclusive area to protect TCD words 2,6,8 */
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetBiter(P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(uint16, AUTOMATIC) Biter)
{
    /* Enter exclusive area to protect TCD words 2,6,8 */
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetMlnoNBytes(P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(uint32, AUTOMATIC) MlnoNBytes)
{
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetSlast(P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(sint32, AUTOMATIC) Slast)
{
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaSetFlags(P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr, VAR(uint8, AUTOMATIC) Flags)
{
...
*
*/
FUNC(boolean, MCL_CODE) Mcl_IPW_DmaTcdGetIntMaj(P2CONST(Mcl_DmaConfigType, AUTOMATIC, MCL_APPL_CONST) Mcl_DmaConfigPtr, VAR(Mcl_ChannelType, AUTOMATIC) nChannel)
{
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaClearDone(P2CONST(Mcl_DmaConfigType, AUTOMATIC, MCL_APPL_CONST) Mcl_DmaConfigPtr, VAR(Mcl_ChannelType, AUTOMATIC) nChannel)
{
...
FUNC(uint16, MCL_CODE) Mcl_IPW_DmaGetCiter(P2VAR(Mcl_DmaTcdType, AUTOMATIC, MCL_APPL_DATA) TcdAddr)
{
    ...
    if((0U)!=(uint16)DMA_TCD_GET_CITER_ELINK((uint32)(TcdAddr)))
    {
        ...
        /** @violates @ref Mcl_IPW_c_REF_13 MISRA 2004 Advisory Rule 11.3, A Cast should not be performed between a pointer type and an integral type */
        /* Compiler_Warning: DMA TCD addresses are restricted to 32 bits, so casting from pointer type to uint32 is safe. Also the cast is needed to access only 2 bytes of the word without accessing the flags. The application should ensure that only addresses that fit in uint32 are used for configuring DMA.*/
        u16returnValue = (uint16)DMA_TCD_GET_CITER_ON((uint32)(TcdAddr));
    }
    else
    {
        /** @violates @ref Mcl_IPW_c_REF_5 MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /** @violates @ref Mcl_IPW_c_REF_13 MISRA 2004 Advisory Rule 11.3, A Cast should not be performed between a pointer type and an integral type */
        /* Compiler_Warning: DMA TCD addresses are restricted to 32 bits, so casting from pointer type to uint32 is safe. Also the cast is needed to access only 2 bytes of the word without accessing the flags. The application should ensure that only addresses that fit in uint32 are used for configuring DMA.*/
        u16returnValue = (uint16)DMA_TCD_GET_CITER_OFF((uint32)(TcdAddr));
    }
...
*
*/
FUNC(boolean, MCL_CODE) Mcl_IPW_DmaGetInterruptRequest(P2CONST(Mcl_DmaConfigType, AUTOMATIC, MCL_APPL_CONST) Mcl_DmaConfigPtr, VAR(Mcl_ChannelType, AUTOMATIC) nChannel)
{
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaEnableHwRequest(P2CONST(Mcl_DmaConfigType, AUTOMATIC, MCL_APPL_CONST) Mcl_DmaConfigPtr, VAR(Mcl_ChannelType, AUTOMATIC) ChannelNumber)
{
    #ifdef MCAL_CACHE_RUNTIME_MNGMNT
    #if (STD_ON == MCAL_CACHE_RUNTIME_MNGMNT)
    #if (STD_ON == MCL_SYNCRONIZE_CACHE)
...
*
*/
FUNC(void, MCL_CODE) Mcl_IPW_DmaDisableHwRequest(P2CONST(Mcl_DmaConfigType, AUTOMATIC, MCL_APPL_CONST) Mcl_DmaConfigPtr, VAR(Mcl_ChannelType, AUTOMATIC) ChannelNumber)
{
...
FUNC(uint16, MCL_CODE) Mcl_IPW_DmaGetChBiter (VAR(Mcl_ChannelType, AUTOMATIC) ChannelNumber)
{
    ...
    if((0U) != (uint16)DMA_TCD_GET_BITER_ELINK((uint32)(DMA_TCD(ChannelNumber))))
    {
        /** @violates @ref Mcl_IPW_c_REF_5 MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /** @violates @ref Mcl_IPW_c_REF_13 MISRA 2004 Advisory Rule 11.3, A Cast should not be performed between a pointer type and an integral type */
        u16returnValue = (uint16)(DMA_GET_CH_BITER(ChannelNumber) & DMA_TCD_BITER_ELINK_YES_MASK_U16);
    }
    else
    {
        /** @violates @ref Mcl_IPW_c_REF_5 MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /** @violates @ref Mcl_IPW_c_REF_13 MISRA 2004 Advisory Rule 11.3, A Cast should not be performed between a pointer type and an integral type */
        u16returnValue = (uint16)(DMA_GET_CH_BITER(ChannelNumber) & DMA_TCD_BITER_ELINK_NO_MASK_U16);
    }
    return u16returnValue;
}
...
FUNC(uint16, MCL_CODE) Mcl_IPW_DmaGetChCiter (VAR(Mcl_ChannelType, AUTOMATIC) ChannelNumber)
{
    ...
    if((0U) != (uint16)DMA_TCD_GET_CITER_ELINK((uint32)(DMA_TCD(ChannelNumber))))
    {
        /** @violates @ref Mcl_IPW_c_REF_5 MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /** @violates @ref Mcl_IPW_c_REF_13 MISRA 2004 Advisory Rule 11.3, A Cast should not be performed between a pointer type and an integral type */
        u16returnValue = (uint16)(DMA_GET_CH_CITER(ChannelNumber) & DMA_TCD_BITER_ELINK_YES_MASK_U16);
    }
    else
    {
        /** @violates @ref Mcl_IPW_c_REF_5 MISRA 2004 Required Rule 11.1, cast from unsigned long to pointer. */
        /** @violates @ref Mcl_IPW_c_REF_13 MISRA 2004 Advisory Rule 11.3, A Cast should not be performed between a pointer type and an integral type */
        u16returnValue = (uint16)(DMA_GET_CH_CITER(ChannelNumber) & DMA_TCD_BITER_ELINK_NO_MASK_U16);
    }
    return u16returnValue;
}
