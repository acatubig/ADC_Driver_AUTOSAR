...
#define MCL_DMA_SW_PATCH_VERSION             4
/**@}*/
...
FUNC(void, MCL_CODE) Mcl_Dma_SetChannelPriority( VAR(Mcl_DmaChannelType, AUTOMATIC) nChannel, VAR(Mcl_DmaPriorityType, AUTOMATIC) nPriority);
...
FUNC (void, MCL_CODE) Mcl_Dma_EnableNotification(VAR(Mcl_DmaChannelType,AUTOMATIC) nChannel, VAR(Mcl_DmaTransferNotifType,AUTOMATIC) Notification);
