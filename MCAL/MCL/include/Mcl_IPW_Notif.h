...
#define MCL_IPW_NOTIF_SW_PATCH_VERSION                4
/**@}*/
...
/** @violates @ref Mcl_IPW_Notif_H_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
#define Mcl_IPW_DmaChannelNotification(Channel)         (Mcl_Notification(Channel))
...
/** @violates @ref Mcl_IPW_Notif_H_REF_2 MISRA 2004 Advisory Rule 19.7, Function-like macro defined. */
#define Mcl_IPW_ErrorNotification(DmaHwInstance,Error)  (Mcl_ErrorNotification((DmaHwInstance),(Error)))
