...
#define DMA_SW_PATCH_VERSION_REG                4
...
*/
    ...
    */
    #define DMA_MOD_BASE_ADDR32(mIdx)         ((uint32)(((mIdx)>0UL) ? (DMA1_BASEADDR) : (DMA0_BASEADDR)))
#else
    /**
    * @brief macro to get the DMA Module address by module index
    * @violates @ref Reg_eSys_DMA_REF_1 MISRA 2004 Advisory Rule 19.7, Function-like macro defined
...
* @violates @ref Reg_eSys_DMA_REF_1 MISRA 2004 Advisory Rule 19.7, Function-like macro defined
*/
#define DMA_MOD_BASE_CH_ADDR32(channel)       ((uint32)(DMA_MOD_BASE_ADDR32(DMA_MOD_IDX_U8(channel))))
/**
* @brief macro to get the DMA Module index by channel
* @violates @ref Reg_eSys_DMA_REF_1 MISRA 2004 Advisory Rule 19.7, Function-like macro defined
*/
#define DMA_MOD_IDX_U8(channel)               ((uint8)((((channel) & (~((uint32)DMA_CTRL_MAX_CHANNELS_MASK_U8)))>0U)? (1U) : (0U)))
...
*/
    ...
    #define DMA_CPR(channel) \
        ((uint32)(DMA_MOD_BASE_CH_ADDR32((channel)) + DMA_CPT_OFFSET_U32 + (LITTLE_ENDIAN_FORMULA((channel) & (uint32)DMA_CTRL_MAX_CHANNELS_MASK_U8))))
#else
    /** @violates @ref Reg_eSys_DMA_REF_1 MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
    #define DMA_CPR(channel) \
        ((uint32)(DMA_MOD_BASE_CH_ADDR32((channel)) + DMA_CPT_OFFSET_U32 + ((channel) & (uint32)DMA_CTRL_MAX_CHANNELS_MASK_U8)))
#endif
    ...
    #define DMA_DCHMID(channel) \
        ((uint32)(DMA_MOD_BASE_CH_ADDR32((channel)) + DMA_DCHMID_OFFSET_U32 + (((channel)) & (uint32)DMA_CTRL_MAX_CHANNELS_MASK_U8)))
#endif
#endif
...
#define DMA_TCD(channel) \
    ((uint32)(DMA_MOD_BASE_CH_ADDR32((channel)) + DMA_TCD_OFFSET_U32 + (((channel) & (uint32)DMA_CTRL_MAX_CHANNELS_MASK_U8)<<5)))
/** @violates @ref Reg_eSys_DMA_REF_1 MISRA 2004 Advisory Rule 19.7, Function-like macro defined */
