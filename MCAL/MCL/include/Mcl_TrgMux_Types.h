...
#define MCL_TRGMUX_TYPES_SW_PATCH_VERSION                4
...
typedef enum
{
    ...
    MCL_TRGMUX_LPI2C1_REG         =27U,
    MCL_TRGMUX_FTM4_REG           =28U,
    MCL_TRGMUX_FTM5_REG           =29U,
    MCL_TRGMUX_FTM6_REG           =30U,
    MCL_TRGMUX_FTM7_REG           =31U
...
typedef struct 
{
...
#ifdef  MCL_TRGMUX_ADC1_AVAILABLE
    ...
    /** @brief TrigMux TRGMUX_LPSPI0 register configuration */
    CONST(Mcl_TrgMuxRegisterType, MCL_CONST) MclTrigMuxLpspi0Config;
#ifdef  MCL_TRGMUX_LPSPI1_AVAILABLE
    /** @brief TrigMux TRGMUX_LPSPI1 register configuration */
