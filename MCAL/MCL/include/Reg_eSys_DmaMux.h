...
#define DMAMUX_REG_SW_PATCH_VERSION               4
...
#if (DMAMUX_REG_VENDOR_ID != MCL_VENDOR_ID_CFG)
    #error "Reg_eSys_DmaMux.h and CDD_Mcl_Cfg.h have different vendor ids"
#endif
/* Check if current file and CDD_Mcl_Cfg header file are of the same Autosar version */
#if (( DMAMUX_REG_AR_RELEASE_MAJOR_VERSION != MCL_AR_RELEASE_MAJOR_VERSION_CFG) || \
     ( DMAMUX_REG_AR_RELEASE_MINOR_VERSION != MCL_AR_RELEASE_MINOR_VERSION_CFG) || \
     ( DMAMUX_REG_AR_RELEASE_REVISION_VERSION !=  MCL_AR_RELEASE_REVISION_VERSION_CFG) \
    )
     #error "AutoSar Version Numbers of Reg_eSys_DmaMux.h and CDD_Mcl_Cfg.h are different"
#endif
/* Check if current file and CDD_Mcl_Cfg header file are of the same software version */
#if ((DMAMUX_REG_SW_MAJOR_VERSION != MCL_SW_MAJOR_VERSION_CFG) || \
     (DMAMUX_REG_SW_MINOR_VERSION != MCL_SW_MINOR_VERSION_CFG) || \
     (DMAMUX_REG_SW_PATCH_VERSION != MCL_SW_PATCH_VERSION_CFG) \
    )
     #error "Software Version Numbers of Reg_eSys_DmaMux.h and CDD_Mcl_Cfg.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
...
#define DMAMUX_LITTLE_ENDIAN_FORMULA(byte) \
            ((((DMAMUX_BYTES_IN_WORD * ((byte) / DMAMUX_BYTES_IN_WORD))) + DMAMUX_BYTES_IN_WORD) -(((byte) % DMAMUX_BYTES_IN_WORD) + 1U))
#endif
...
* @violates @ref REG_ESYS_DMAMUX_H_REF_1 MISRA 2004 Advisory Rule 19.7, Function-like macro defined.
*/
#define DMACHMUX_CHCONFIG(u8channel, u8instance) (DMAMUX_BASE_ADDR32[(u8instance)] + (uint32)DMAMUX_LITTLE_ENDIAN_FORMULA((u8channel)))
#else
/**
* @brief macros used to calculate the address of a CHCONFIG register.
* @violates @ref REG_ESYS_DMAMUX_H_REF_1 MISRA 2004 Advisory Rule 19.7, Function-like macro defined.
*/
#define DMACHMUX_CHCONFIG(u8channel, u8instance) (DMAMUX_BASE_ADDR32[(u8instance)] + (u8channel))
#endif
/**
