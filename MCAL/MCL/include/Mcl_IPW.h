...
#define MCL_IPW_SW_PATCH_VERSION                4
...
#if (MCL_ENABLE_FLEXIO == STD_ON)
    #if (MCL_IPW_VENDOR_ID != FLEXIO_COMMON_VENDOR_ID)
        #error "Mcl_IPW.h and Mcl_FlexIO_Common.h have different vendor IDs"
    #endif
    /* Check if source file and Mcl_FlexIO_Common header file are of the same Autosar version */
    #if ((MCL_IPW_AR_RELEASE_MAJOR_VERSION != FLEXIO_COMMON_AR_RELEASE_MAJOR_VERSION) || \
         (MCL_IPW_AR_RELEASE_MINOR_VERSION != FLEXIO_COMMON_AR_RELEASE_MINOR_VERSION) || \
         (MCL_IPW_AR_RELEASE_REVISION_VERSION != FLEXIO_COMMON_AR_RELEASE_REVISION_VERSION) \
        )
    #error "AutoSar Version Numbers of Mcl_IPW.h and Mcl_FlexIO_Common.h are different"
    #endif
    /* Check if source file and Mcl_FlexIO_Common header file are of the same Software version */
    #if ((MCL_IPW_SW_MAJOR_VERSION != FLEXIO_COMMON_SW_MAJOR_VERSION) || \
         (MCL_IPW_SW_MINOR_VERSION != FLEXIO_COMMON_SW_MINOR_VERSION) || \
         (MCL_IPW_SW_PATCH_VERSION != FLEXIO_COMMON_SW_PATCH_VERSION) \
        )
    #error "Software Version Numbers of Mcl_IPW.h and Mcl_FlexIO_Common.h are different"
    #endif
#endif
...
==================================================================================================*/
     ...
     * @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined
     */
    #define Mcl_IPW_TrgMuxConfigInput(RegisterIndex,selNumber,source) (CALL_TRGMUX_CONFIG_SEL((RegisterIndex),(selNumber),(source)))
    /*
     * @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined
     */
    #define Mcl_IPW_TrgMuxGetLock(RegisterIndex)                      (TRGMUX_GET_LOCK(RegisterIndex))
    /*
     * @violates @ref Mcl_IPW_h_REF_1  MISRA 2004 Advisory Rule 19.7, Function-like macro defined
     */
    #define Mcl_IPW_TrgMuxEnableLock(RegisterIndex)                   (CALL_TRGMUX_ENABLE_LOCK(RegisterIndex))
